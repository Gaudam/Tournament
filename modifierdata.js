  const modifierData = [
    ...
    { name: "Warding Aura", multiplier: 1.45, description: "Allies within 10 feet gain +1 AC." },
    ...
    { name: "Swarm-Mind", multiplier: 1.5, description: "Cannot be flanked." },
    ...
    { name: "Aura of Fear", multiplier: 1.9, description: "Enemies within 30 feet have disadvantage on Wisdom saves." },
    ...
    { name: "Gravity-Well (Empowered)", multiplier: 2.0, description: "Creatures within 20 feet are pulled 5 feet toward the monster." },
    ...
    { name: "Acrobatic", multiplier: 2.0, description: "Immune to the prone condition and takes no damage from falling." },
    ...
    { name: "Spell-Storing", multiplier: 2.5, description: "When the monster dies, it releases a stored spell (like Fireball or Web) centered on itself." },
    ...
    { name: "God-Heart", multiplier: 2.9, description: "Regains 5% of its total HP at the start of every turn." },
    ...
    { name: "Soul-Reaper", multiplier: 3.0, description: "If a player drops to 0 HP, they are automatically stabilized but have a permanent -2 to all saves." },
    ...
    { name: "Spirit-Sever", multiplier: 3.0, description: "If a creature is reduced to 0 HP by this monster, it dies instantly and cannot be revived." },
    ...
    { name: "Infinite-Resilience", multiplier: 3.2, description: "Cannot take more than 50 damage in a single turn." },
    ...
    { name: "Avatar of Death", multiplier: 3.5, description: "Its attacks bypass all resistances and immunities, including temporary hit points." },
    ...
    { name: "Hive-Queen", multiplier: 4.0, description: "Spawns 1d4 minion monsters at the start of every turn without requiring an action." },
    { name: "Temporal Anomaly", multiplier: 4.0, description: "Whenever the monster is hit, the attacker must save or be banished forward in time, losing their next turn." },
    { name: "Spell-Reflect", multiplier: 4.0, description: "If it succeeds on a save against a spell, the spell is reflected back at the caster." },
    ...
    { name: "Absolute-Immunity", multiplier: 4.5, description: "Completely immune to bludgeoning, piercing, and slashing damage from non-magical weapons." },
    { name: "Spell-Devourer", multiplier: 4.5, description: "Has advantage on all spell saves. If it succeeds, it absorbs the magic, healing for the spell's damage." },
    ...
    { name: "Fatal-Focus", multiplier: 4.75, description: "Targets the player with the lowest AC and never switches until they fall." },
    { name: "All-Resistant", multiplier: 5.0, description: "The monster is resistant to all damage types." },
    { name: "Broken-Limitation", multiplier: 5.0, description: "Can take 2 reactions per round." },
    { name: "Final-Stand", multiplier: 5.0, description: "When at 20% HP, it gains resistance to all damage types." },
    ...
    { name: "The Unstoppable", multiplier: 5.0, description: "Immunity to all conditions and damage less than 20." },
    { name: "Inevitable", multiplier: 5.0, description: "The monster's attacks never miss, and it cannot be hidden from or escaped via teleportation." },
    { name: "Omniscient", multiplier: 5.0, description: "Automatically succeeds on all saving throws and its attacks ignore AC, automatically hitting unless the target casts Shield." },
    { name: "Omni-Elemental", multiplier: 5.5, description: "Its attacks deal an extra 1d6 fire, 1d6 cold, 1d6 lightning, and 1d6 acid damage simultaneously." },
    { name: "The Final Boss", multiplier: 6.0, description: "Has Mythic Actions, 3 Legendary Actions, and Legendary Resistance (3/Day)." },
    { name: "Nemesis", multiplier: 7.0, description: "This ability modify the user's abilities, spells, and tactics to counter the enemy." },
    { name: "The Director", multiplier: 7.0, description: "Can pause the fight as a mythic action, swap the players' held items, alter their prepared spells, and rewrite their current HP pools and abilities before resuming." }
